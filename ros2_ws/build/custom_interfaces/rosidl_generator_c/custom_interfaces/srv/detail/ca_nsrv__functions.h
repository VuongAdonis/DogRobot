...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__CA_NSRV__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__CA_NSRV__FUNCTIONS_H_
 ...
 * )) before or use
 * custom_interfaces__srv__CANsrv_Request__create()
...
/// Create srv/CANsrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__CANsrv_Request__init().
...
/// Destroy srv/CANsrv message.
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Request__fini()
...
/// Check for srv/CANsrv message equality.
/**
...
/// Initialize array of srv/CANsrv messages.
/**
...
/// Finalize array of srv/CANsrv messages.
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Request__fini()
...
/// Create array of srv/CANsrv messages.
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__CANsrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CANsrv messages.
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CANsrv message array equality.
/**
...
/// Copy an array of srv/CANsrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * custom_interfaces__srv__CANsrv_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__CANsrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__CANsrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * custom_interfaces__srv__CANsrv_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__CANsrv_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__CANsrv_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__CANsrv_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__CA_NSRV__FUNCTIONS_H_
