...
static const _GamepadSrv_Request_type_support_symbol_names_t _GamepadSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GamepadSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, srv, GamepadSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces, srv, GamepadSrv_Request)() {
  return &::custom_interfaces::srv::rosidl_typesupport_c::GamepadSrv_Request_message_type_support_handle;
}
...
static const _GamepadSrv_Response_type_support_symbol_names_t _GamepadSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GamepadSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, srv, GamepadSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces, srv, GamepadSrv_Response)() {
  return &::custom_interfaces::srv::rosidl_typesupport_c::GamepadSrv_Response_message_type_support_handle;
}
...
static const _GamepadSrv_Event_type_support_symbol_names_t _GamepadSrv_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GamepadSrv_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, srv, GamepadSrv_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces, srv, GamepadSrv_Event)() {
  return &::custom_interfaces::srv::rosidl_typesupport_c::GamepadSrv_Event_message_type_support_handle;
}
...
static const _GamepadSrv_type_support_symbol_names_t _GamepadSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, GamepadSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, srv, GamepadSrv)),
  }
};
...
static const rosidl_service_type_support_t GamepadSrv_service_type_support_handle = {
  ...
  &GamepadSrv_Request_message_type_support_handle,
  &GamepadSrv_Response_message_type_support_handle,
  &GamepadSrv_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, custom_interfaces, srv, GamepadSrv)() {
  return &::custom_interfaces::srv::rosidl_typesupport_c::GamepadSrv_service_type_support_handle;
}
