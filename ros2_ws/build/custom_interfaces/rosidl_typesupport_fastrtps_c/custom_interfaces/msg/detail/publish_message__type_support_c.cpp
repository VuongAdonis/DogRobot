...
#include "custom_interfaces/msg/detail/publish_message__rosidl_typesupport_fastrtps_c.h"
...
using _PublishMessage__ros_msg_type = custom_interfaces__msg__PublishMessage;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
bool cdr_serialize_custom_interfaces__msg__PublishMessage(
  const custom_interfaces__msg__PublishMessage * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
bool cdr_deserialize_custom_interfaces__msg__PublishMessage(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces__msg__PublishMessage * ros_message)
{
  // Field name: namerr
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__msg__PublishMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PublishMessage__ros_msg_type * ros_message = static_cast<const _PublishMessage__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__PublishMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__msg__PublishMessage;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
bool cdr_serialize_key_custom_interfaces__msg__PublishMessage(
  const custom_interfaces__msg__PublishMessage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: namerr
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_key_custom_interfaces__msg__PublishMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PublishMessage__ros_msg_type * ros_message = static_cast<const _PublishMessage__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_key_custom_interfaces__msg__PublishMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_interfaces__msg__PublishMessage * ros_message = static_cast<const custom_interfaces__msg__PublishMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_interfaces__msg__PublishMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_interfaces__msg__PublishMessage * ros_message = static_cast<custom_interfaces__msg__PublishMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_interfaces__msg__PublishMessage(cdr, ros_message);
}

static uint32_t _PublishMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__PublishMessage(
...
static size_t _PublishMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__PublishMessage(
...
static message_type_support_callbacks_t __callbacks_PublishMessage = {
...
static rosidl_message_type_support_t _PublishMessage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PublishMessage,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, PublishMessage)() {
  return &_PublishMessage__type_support;
}
