...
class Metaclass_IMU_Event(type):
    """Metaclass of message 'IMU_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__imu__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__imu__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__imu__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__imu__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__imu__event
...
class IMU_Event(metaclass=Metaclass_IMU_Event):
    """Message class 'IMU_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<custom_interfaces/IMU_Request, 1>',
        'response': 'sequence<custom_interfaces/IMU_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_interfaces', 'srv'], 'IMU_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_interfaces', 'srv'], 'IMU_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_interfaces.srv import IMU_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IMU_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'IMU_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from custom_interfaces.srv import IMU_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, IMU_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'IMU_Response'"
...
class Metaclass_IMU(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_interfaces.srv import _imu
            ...
            if _imu.Metaclass_IMU_Event._TYPE_SUPPORT is None:
                _imu.Metaclass_IMU_Event.__import_type_support__()


class IMU(metaclass=Metaclass_IMU):
    from custom_interfaces.srv._imu import IMU_Request as Request
    from custom_interfaces.srv._imu import IMU_Response as Response
    from custom_interfaces.srv._imu import IMU_Event as Event
